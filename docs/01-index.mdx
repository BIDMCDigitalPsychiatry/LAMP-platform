...
<div className="padding-vert--lg margin-vert--lg" style={{ backgroundColor: "#f9fafb" }}>
  ...
  <Tabs groupId="challenge" defaultValue="measurement" values={[
    ...
    <TabItem value="measurement">
      ...
      <div className="card margin-top--md">
        <div className="card__header">
          <span className="badge badge--secondary">MindLAMP's Solution</span>
        ...
        <div className="card__body">
          ...
          <p className="margin-top--sm">
            <Link to="https://docs.lamp.digital/using/sensors">Explore LAMP Sensors →</Link><br/>
            <Link to="https://docs.lamp.digital/start_here/activities/activities">Explore LAMP Activities →</Link>
          </p>
        </div>
      </div>
    </TabItem>
    ...
    <TabItem value="flexibility">
      ...
      <div className="card margin-top--md">
        ...
        <div className="card__body">
          ...
          <p className="margin-top--sm">
            <Link to="https://docs.lamp.digital/api">Explore LAMP API Documentation →</Link><br/>
            <Link to="https://docs.lamp.digital/data_science/cortex/what_is_cortex">Explore Cortex Documentation →</Link>
          </p>
        </div>
      </div>
    </TabItem>
...
<p className="margin-top--sm">
  <Link to="https://docs.lamp.digital/quick_links/interest">Join LAMP CORE →</Link>
</p>
...
<Link to="https://docs.lamp.digital/quick_links/users">Read Case Studies →</Link>
