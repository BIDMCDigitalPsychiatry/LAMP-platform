...
<Tabs groupId="challenge" defaultValue="measurement" values={[
  ...
  {label: 'Access to Care', value: 'access'},
  {label: 'Connection', value: 'connection'},
]}>
  <TabItem value="measurement">
    <div className="card">
      <div className="card__header">
        <span className="badge badge--secondary">What’s hard today</span>
        <h3 className="margin-top--xs">Measurement</h3>
      </div>
      <div className="card__body">
        <p>
          Interviews, questionnaires, and brief visits are valuable—but they are <em>snapshots</em>. They are infrequent, rely on recall, and often miss the day-to-day dynamics that matter in mental health, cognition, and neurology.
        </p>
      </div>
    </div>
    ...
    <div className="card margin-top--md">
      <div className="card__header">
        <span className="badge badge--success">How mindLAMP responds</span>
        <h3 className="margin-top--xs">Continuous, ecologically valid data</h3>
      </div>
      <div className="card__body">
        <p>
  ...
  <TabItem value="access">
    <div className="card">
      <div className="card__header">
        <span className="badge badge--secondary">What’s hard today</span>
        <h3 className="margin-top--xs">Access to Care</h3>
      </div>
      <div className="card__body">
        <p>
          Many face provider shortages, waitlists, costs, stigma, and geographic barriers. Even when care is available, it’s often limited to brief, infrequent encounters with little monitoring or support between visits.
        </p>
      </div>
    </div>
    ...
    <div className="card margin-top--md">
      <div className="card__header">
        <span className="badge badge--success">How mindLAMP responds</span>
        <h3 className="margin-top--xs">Care beyond the visit</h3>
      </div>
      <div className="card__body">
        <p>
  ...
  <TabItem value="connection">
    ...
    <div className="card margin-top--md">
      <div className="card__header">
        <span className="badge badge--success">How mindLAMP responds</span>
        <h3 className="margin-top--xs">A shared data environment</h3>
      </div>
      <div className="card__body">
        <p>
          The <strong>App</strong> and <strong>Dashboard</strong> are two sides of the same environment: participants contribute and learn from their data; teams interpret, visualize, and act on it. Optional messaging and just-in-time prompts close the loop so participants are active contributors rather than passive data sources.
        </p>
        <p>
          Under the hood, the <strong>Database</strong> (LAMP Protocol) provides reliable structure and access, and <strong>Cortex</strong> turns raw signals into features and visualizations that are easier to reason about.
        </p>
        <p className="margin-top--sm">
