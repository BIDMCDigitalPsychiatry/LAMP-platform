---
slug: "/dashboard/activities-tab"
sidebar_position: 2
sidebar_label: Activities Tab
title: "Activities Tab"
description: "Create and configure surveys, cognitive games, tips, and other activities for your study."
---
...
![The Activities tab showing activity cards with name, type, group, and edit/schedule icons](../assets/activities_tab_overview.png)
...
![+ Add menu showing Import activities, Create a new Activity Group or Survey Instrument, and available cognitive tests and activities](../assets/activities_add_menu.png)
...
![Activity card showing Edit activity tooltip on pencil icon](../assets/activities_edit_tooltip.png)
...
![Selected activity with Export and Delete action bar](../assets/activities_selected_actions.png)
