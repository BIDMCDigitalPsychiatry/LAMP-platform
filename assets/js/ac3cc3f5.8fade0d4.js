"use strict";
(self["webpackChunkLAMP_documentation"] = self["webpackChunkLAMP_documentation"] || []).push([[1488,9090],{
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 * ========================================================================== */function getSidebar(_ref){let{currentApiRoute,apiMetadata}=_ref;const sidebarName=currentApiRoute.sidebar;const sidebar=sidebarName?apiMetadata.apiSidebars[sidebarName]:undefined;return sidebar;}function getLinks(sidebar){let links=[];for(let item of sidebar){switch(item.type){case"link":links.push(item.href);break;case"category":links.push(...getLinks(item.items));break;}}return links;}function getSidebarPaths(_ref2){let{currentApiRoute,apiMetadata}=_ref2;const sidebar=getSidebar({currentApiRoute,apiMetadata});if(!sidebar){return[];}return getLinks(sidebar);}function ApiPageContent(_ref3){let{currentApiRoute,apiMetadata,children}=_ref3;const sidebar=getSidebar({currentApiRoute,apiMetadata});const[hiddenSidebarContainer,setHiddenSidebarContainer]=(0,react.useState)(false);const[hiddenSidebar,setHiddenSidebar]=(0,react.useState)(false);const toggleSidebar=(0,react.useCallback)(()=>{if(hiddenSidebar){setHiddenSidebar(false);}setHiddenSidebarContainer(value=>!value);},[hiddenSidebar]);return/*#__PURE__*/react.createElement(Layout/* default */.A,{wrapperClassName:"api-wrapper",pageClassName:"api-page"},/*#__PURE__*/react.createElement("div",{className:styles_module.apiPage},/*#__PURE__*/react.createElement(BackToTopButton/* default */.A,null),sidebar&&/*#__PURE__*/react.createElement("aside",{className:(0,clsx_m/* default */.A)(styles_module.apiSidebarContainer,{[styles_module.apiSidebarContainerHidden]:hiddenSidebarContainer}),onTransitionEnd:e=>{if(!e.currentTarget.classList.contains(styles_module.apiSidebarContainer)){return;}if(hiddenSidebarContainer){setHiddenSidebar(true);}}},/*#__PURE__*/react.createElement(DocSidebar/* default */.A,{key:// Reset sidebar state on sidebar changes
// See https://github.com/facebook/docusaurus/issues/3414
currentApiRoute.sidebar,sidebar:sidebar,path:currentApiRoute.path,onCollapse:toggleSidebar,isHidden:hiddenSidebar}),hiddenSidebar&&/*#__PURE__*/react.createElement("div",{className:styles_module.collapsedApiSidebar,title:(0,Translate/* translate */.T)({id:"theme.docs.sidebar.expandButtonTitle",message:"Expand sidebar",description:"The ARIA label and title attribute for expand button of doc sidebar"}),"aria-label":(0,Translate/* translate */.T)({id:"theme.docs.sidebar.expandButtonAriaLabel",message:"Expand sidebar",description:"The ARIA label and title attribute for expand button of doc sidebar"}),tabIndex:0,role:"button",onKeyDown:toggleSidebar,onClick:toggleSidebar},/*#__PURE__*/react.createElement(IconArrow/* default */.A,{className:styles_module.expandSidebarButtonIcon}))),/*#__PURE__*/react.createElement("main",{className:(0,clsx_m/* default */.A)(styles_module.apiMainContainer,{[styles_module.apiMainContainerEnhanced]:hiddenSidebarContainer||!sidebar})},/*#__PURE__*/react.createElement("div",{className:(0,clsx_m/* default */.A)("container padding-top--md padding-bottom--lg",{[styles_module.apiItemWrapperEnhanced]:hiddenSidebarContainer})},/*#__PURE__*/react.createElement(esm/* MDXProvider */.xA,{components:MDXComponents/* default */.A},children)))));}function ApiPage(props){const{route:{routes:apiRoutes},apiMetadata,location}=props;let currentApiRoute=apiRoutes.find(apiRoute=>(0,react_router/* matchPath */.B6)(location.pathname,apiRoute));if(!currentApiRoute){return/*#__PURE__*/react.createElement(NotFound["default"],null);}// Override the current route path to the first page if it can't be found on the sidebar.
const paths=getSidebarPaths({currentApiRoute,apiMetadata});if(!paths.find(path=>(0,react_router/* matchPath */.B6)(location.pathname,path))){currentApiRoute={...currentApiRoute,path:paths[0]};}return/*#__PURE__*/react.createElement(react.Fragment,null,/*#__PURE__*/react.createElement(ApiPageContent,{currentApiRoute:currentApiRoute,apiMetadata:apiMetadata},(0,renderRoutes/* default */.A)(apiRoutes)));}/* harmony default export */ const theme_ApiPage = (ApiPage);
