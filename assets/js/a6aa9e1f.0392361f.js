 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */function BlogListPage(props){const{metadata,items,sidebar}=props;const{siteConfig:{title:siteTitle}}=(0,useDocusaurusContext/* default */.Z)();const{blogDescription,blogTitle,permalink}=metadata;const isBlogOnlyMode=permalink==='/';const title=isBlogOnlyMode?siteTitle:blogTitle;return/*#__PURE__*/react.createElement(BlogLayout/* default */.Z,{title:title,description:blogDescription,wrapperClassName:lib/* ThemeClassNames */.kM.wrapper.blogPages,pageClassName:lib/* ThemeClassNames */.kM.page.blogListPage,searchMetadata:{// assign unique search tag to exclude this page from search results!
