"use strict";
(self["webpackChunkLAMP_documentation"] = self["webpackChunkLAMP_documentation"] || []).push([[9648],{
...
var ExecutionEnvironment = __webpack_require__(98684);
...
var fetchIndexes = __webpack_require__(74352);
...
function SearchPage(){const{siteConfig:{baseUrl}}=(0,useDocusaurusContext/* default */.c)();const{searchValue,updateSearchPath}=hooks_useSearchQuery();const[searchQuery,setSearchQuery]=(0,react.useState)(searchValue);const[searchSource,setSearchSource]=(0,react.useState)();const[searchResults,setSearchResults]=(0,react.useState)();const pageTitle=(0,react.useMemo)(()=>searchQuery?simpleTemplate(proxiedGenerated/* translations */.uI.search_results_for,{keyword:searchQuery}):proxiedGenerated/* translations */.uI.search_the_documentation,[searchQuery]);(0,react.useEffect)(()=>{updateSearchPath(searchQuery);if(searchSource){if(searchQuery){searchSource(searchQuery,results=>{setSearchResults(results);});}else{setSearchResults(undefined);}}// `updateSearchPath` should not be in the deps,
// otherwise will cause call stack overflow.
},[searchQuery,searchSource]);const handleSearchInputChange=(0,react.useCallback)(e=>{setSearchQuery(e.target.value);},[]);(0,react.useEffect)(()=>{if(searchValue&&searchValue!==searchQuery){setSearchQuery(searchValue);}},[searchValue]);(0,react.useEffect)(()=>{async function doFetchIndexes(){const{wrappedIndexes,zhDictionary}=await (0,fetchIndexes/* fetchIndexes */.i)(baseUrl);setSearchSource(()=>(0,SearchSourceFactory/* SearchSourceFactory */.r)(wrappedIndexes,zhDictionary,100));}doFetchIndexes();},[baseUrl]);return/*#__PURE__*/react.createElement(Layout/* default */.c,{title:pageTitle},/*#__PURE__*/react.createElement(Head/* default */.c,null,/*#__PURE__*/react.createElement("meta",{property:"robots",content:"noindex, follow"})),/*#__PURE__*/react.createElement("div",{className:"container margin-vert--lg"},/*#__PURE__*/react.createElement("h1",null,pageTitle),/*#__PURE__*/react.createElement("input",{type:"search",name:"q",className:SearchPage_module.searchQueryInput,"aria-label":"Search",onChange:handleSearchInputChange,value:searchQuery,autoComplete:"off",autoFocus:true}),!searchSource&&searchQuery&&/*#__PURE__*/react.createElement("div",null,/*#__PURE__*/react.createElement(LoadingRing/* default */.c,null)),searchResults&&(searchResults.length>0?/*#__PURE__*/react.createElement("p",null,simpleTemplate(searchResults.length===1?proxiedGenerated/* translations */.uI.count_documents_found:proxiedGenerated/* translations */.uI.count_documents_found_plural,{count:searchResults.length})): true?/*#__PURE__*/react.createElement("p",null,proxiedGenerated/* translations */.uI.no_documents_were_found):/*#__PURE__*/0),/*#__PURE__*/react.createElement("section",null,searchResults&&searchResults.map(item=>/*#__PURE__*/react.createElement(SearchResultItem,{key:item.document.i,searchResult:item})))));}function SearchResultItem(_ref){let{searchResult:{document,type,page,tokens,metadata}}=_ref;const isTitle=type===0;const isContent=type===2;const pathItems=(isTitle?document.b:page.b).slice();const articleTitle=isContent?document.s:document.t;if(!isTitle){pathItems.push(page.t);}return/*#__PURE__*/react.createElement("article",{className:SearchPage_module.searchResultItem},/*#__PURE__*/react.createElement("h2",null,/*#__PURE__*/react.createElement(Link/* default */.c,{to:document.u+(document.h||""),dangerouslySetInnerHTML:{__html:isContent?(0,highlight/* highlight */.s)(articleTitle,tokens):(0,highlightStemmed/* highlightStemmed */.K)(articleTitle,(0,getStemmedPositions/* getStemmedPositions */.A)(metadata,"t"),tokens,100)}})),pathItems.length>0&&/*#__PURE__*/react.createElement("p",{className:SearchPage_module.searchResultItemPath},pathItems.join(" › ")),isContent&&/*#__PURE__*/react.createElement("p",{className:SearchPage_module.searchResultItemSummary,dangerouslySetInnerHTML:{__html:(0,highlightStemmed/* highlightStemmed */.K)(document.t,(0,getStemmedPositions/* getStemmedPositions */.A)(metadata,"t"),tokens,100)}}));}
