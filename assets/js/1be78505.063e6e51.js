"use strict";
(self["webpackChunkLAMP_documentation"] = self["webpackChunkLAMP_documentation"] || []).push([[8714,9090],{
...
__webpack_require__.d(__webpack_exports__, {
  A: () => (/* binding */ theme_BackToTopButton)
});
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */function DocPageContent(_ref){let{currentDocRoute,versionMetadata,children,sidebarName}=_ref;const sidebar=(0,lib/* useDocsSidebar */.ts)();const{pluginId,version}=versionMetadata;const[hiddenSidebarContainer,setHiddenSidebarContainer]=(0,react.useState)(false);const[hiddenSidebar,setHiddenSidebar]=(0,react.useState)(false);const toggleSidebar=(0,react.useCallback)(()=>{if(hiddenSidebar){setHiddenSidebar(false);}setHiddenSidebarContainer(value=>!value);},[hiddenSidebar]);return/*#__PURE__*/react.createElement(Layout/* default */.A,{wrapperClassName:lib/* ThemeClassNames */.GN.wrapper.docsPages,pageClassName:lib/* ThemeClassNames */.GN.page.docsDocPage,searchMetadata:{version,tag:(0,lib/* docVersionSearchTag */.tU)(pluginId,version)}},/*#__PURE__*/react.createElement("div",{className:styles_module.docPage},/*#__PURE__*/react.createElement(BackToTopButton/* default */.A,null),sidebar&&/*#__PURE__*/react.createElement("aside",{className:(0,clsx_m/* default */.A)(styles_module.docSidebarContainer,{[styles_module.docSidebarContainerHidden]:hiddenSidebarContainer}),onTransitionEnd:e=>{if(!e.currentTarget.classList.contains(styles_module.docSidebarContainer)){return;}if(hiddenSidebarContainer){setHiddenSidebar(true);}}},/*#__PURE__*/react.createElement(DocSidebar/* default */.A,{key:// Reset sidebar state on sidebar changes
// See https://github.com/facebook/docusaurus/issues/3414
sidebarName,sidebar:sidebar,path:currentDocRoute.path,onCollapse:toggleSidebar,isHidden:hiddenSidebar}),hiddenSidebar&&/*#__PURE__*/react.createElement("div",{className:styles_module.collapsedDocSidebar,title:(0,Translate/* translate */.T)({id:'theme.docs.sidebar.expandButtonTitle',message:'Expand sidebar',description:'The ARIA label and title attribute for expand button of doc sidebar'}),"aria-label":(0,Translate/* translate */.T)({id:'theme.docs.sidebar.expandButtonAriaLabel',message:'Expand sidebar',description:'The ARIA label and title attribute for expand button of doc sidebar'}),tabIndex:0,role:"button",onKeyDown:toggleSidebar,onClick:toggleSidebar},/*#__PURE__*/react.createElement(IconArrow/* default */.A,{className:styles_module.expandSidebarButtonIcon}))),/*#__PURE__*/react.createElement("main",{className:(0,clsx_m/* default */.A)(styles_module.docMainContainer,{[styles_module.docMainContainerEnhanced]:hiddenSidebarContainer||!sidebar})},/*#__PURE__*/react.createElement("div",{className:(0,clsx_m/* default */.A)('container padding-top--md padding-bottom--lg',styles_module.docItemWrapper,{[styles_module.docItemWrapperEnhanced]:hiddenSidebarContainer})},/*#__PURE__*/react.createElement(esm/* MDXProvider */.xA,{components:MDXComponents/* default */.A},children)))));}function DocPage(props){const{route:{routes:docRoutes},versionMetadata,location}=props;const currentDocRoute=docRoutes.find(docRoute=>(0,react_router/* matchPath */.B6)(location.pathname,docRoute));if(!currentDocRoute){return/*#__PURE__*/react.createElement(NotFound["default"],null);}// For now, the sidebarName is added as route config: not ideal!
const sidebarName=currentDocRoute.sidebar;const sidebar=sidebarName?versionMetadata.docsSidebars[sidebarName]:null;return/*#__PURE__*/react.createElement(react.Fragment,null,/*#__PURE__*/react.createElement(Head/* default */.A,null,/*#__PURE__*/react.createElement("html",{className:versionMetadata.className})),/*#__PURE__*/react.createElement(lib/* DocsVersionProvider */.nM,{version:versionMetadata},/*#__PURE__*/react.createElement(lib/* DocsSidebarProvider */.VB,{sidebar:sidebar},/*#__PURE__*/react.createElement(DocPageContent,{currentDocRoute:currentDocRoute,versionMetadata:versionMetadata,sidebarName:sidebarName},(0,renderRoutes/* default */.A)(docRoutes,{versionMetadata})))));}/* harmony default export */ const theme_DocPage = (DocPage);
...
const DocSidebarItems=/*#__PURE__*/(0,react.memo)(_ref=>{let{items,...props}=_ref;return/*#__PURE__*/react.createElement(react.Fragment,null,items.map((item,index)=>/*#__PURE__*/react.createElement(DocSidebarItem,(0,esm_extends/* default */.A)({key:index// sidebar is static, the index does not change
,item:item},props))));});function DocSidebarItem(_ref2){let{item,...props}=_ref2;switch(item.type){case'category':if(item.items.length===0){return null;}return/*#__PURE__*/react.createElement(DocSidebarItemCategory,(0,esm_extends/* default */.A)({item:item},props));case'link':default:return/*#__PURE__*/react.createElement(DocSidebarItemLink,(0,esm_extends/* default */.A)({item:item},props));}}// If we navigate to a category and it becomes active, it should automatically expand itself
function useAutoExpandActiveCategory(_ref3){let{isActive,collapsed,setCollapsed}=_ref3;const wasActive=(0,lib/* usePrevious */.ZC)(isActive);(0,react.useEffect)(()=>{const justBecameActive=isActive&&!wasActive;if(justBecameActive&&collapsed){setCollapsed(false);}},[isActive,wasActive,collapsed,setCollapsed]);}// When a collapsible category has no link, we still link it to its first child during SSR as a temporary fallback
...
if(isBrowser||!item.collapsible){return undefined;}return (0,lib/* findFirstCategoryLink */._o)(item);},[item,isBrowser]);}function DocSidebarItemCategory(_ref4){let{item,onItemClick,activePath,level,...props}=_ref4;const{items,label,collapsible,className,href}=item;const hrefWithSSRFallback=useCategoryHrefWithSSRFallback(item);const isActive=(0,lib/* isActiveSidebarItem */.w8)(item,activePath);const{collapsed,setCollapsed,toggleCollapsed}=(0,lib/* useCollapsible */.uW)({// active categories are always initialized as expanded
// the default (item.collapsed) is only used for non-active categories
initialState:()=>{if(!collapsible){return false;}return isActive?false:item.collapsed;}});useAutoExpandActiveCategory({isActive,collapsed,setCollapsed});return/*#__PURE__*/react.createElement("li",{className:(0,clsx_m/* default */.A)(lib/* ThemeClassNames */.GN.docs.docSidebarItemCategory,lib/* ThemeClassNames */.GN.docs.docSidebarItemCategoryLevel(level),'menu__list-item',{'menu__list-item--collapsed':collapsed},className)},/*#__PURE__*/react.createElement("div",{className:"menu__list-item-collapsible"},/*#__PURE__*/react.createElement(Link/* default */.A,(0,esm_extends/* default */.A)({className:(0,clsx_m/* default */.A)('menu__link',{'menu__link--sublist':collapsible&&!href,'menu__link--active':isActive,[styles_module.menuLinkText]:!collapsible,[styles_module.hasHref]:!!hrefWithSSRFallback}),onClick:collapsible?e=>{onItemClick?.(item);if(href){setCollapsed(false);}else{e.preventDefault();toggleCollapsed();}}:()=>{onItemClick?.(item);},href:collapsible?hrefWithSSRFallback??'#':hrefWithSSRFallback},props),label),href&&collapsible&&/*#__PURE__*/react.createElement("button",{"aria-label":(0,Translate/* translate */.T)({id:'theme.DocSidebarItem.toggleCollapsedCategoryAriaLabel',message:"Toggle the collapsible sidebar category '{label}'",description:'The ARIA label to toggle the collapsible sidebar category'},{label}),type:"button",className:"clean-btn menu__caret",onClick:e=>{e.preventDefault();toggleCollapsed();}})),/*#__PURE__*/react.createElement(lib/* Collapsible */.Nt,{lazy:true,as:"ul",className:"menu__list",collapsed:collapsed},/*#__PURE__*/react.createElement(DocSidebarItems,{items:items,tabIndex:collapsed?-1:0,onItemClick:onItemClick,activePath:activePath,level:level+1})));}function DocSidebarItemLink(_ref5){let{item,onItemClick,activePath,level,...props}=_ref5;const{href,label,className}=item;const isActive=(0,lib/* isActiveSidebarItem */.w8)(item,activePath);return/*#__PURE__*/react.createElement("li",{className:(0,clsx_m/* default */.A)(lib/* ThemeClassNames */.GN.docs.docSidebarItemLink,lib/* ThemeClassNames */.GN.docs.docSidebarItemLinkLevel(level),'menu__list-item',className),key:label},/*#__PURE__*/react.createElement(Link/* default */.A,(0,esm_extends/* default */.A)({className:(0,clsx_m/* default */.A)('menu__link',{'menu__link--active':isActive}),"aria-current":isActive?'page':undefined,to:href},(0,isInternalUrl/* default */.A)(href)&&{onClick:onItemClick?()=>onItemClick(item):undefined},props),(0,isInternalUrl/* default */.A)(href)?label:/*#__PURE__*/react.createElement("span",null,label,/*#__PURE__*/react.createElement(IconExternalLink/* default */.A,null))));}
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */function useShowAnnouncementBar(){const{isActive}=(0,lib/* useAnnouncementBar */.Mj)();const[showAnnouncementBar,setShowAnnouncementBar]=(0,react.useState)(isActive);(0,lib/* useScrollPosition */.Mq)(_ref=>{let{scrollY}=_ref;if(isActive){setShowAnnouncementBar(scrollY===0);}},[isActive]);return isActive&&showAnnouncementBar;}function HideableSidebarButton(_ref2){let{onClick}=_ref2;return/*#__PURE__*/react.createElement("button",{type:"button",title:(0,Translate/* translate */.T)({id:'theme.docs.sidebar.collapseButtonTitle',message:'Collapse sidebar',description:'The title attribute for collapse button of doc sidebar'}),"aria-label":(0,Translate/* translate */.T)({id:'theme.docs.sidebar.collapseButtonAriaLabel',message:'Collapse sidebar',description:'The title attribute for collapse button of doc sidebar'}),className:(0,clsx_m/* default */.A)('button button--secondary button--outline',DocSidebar_styles_module.collapseSidebarButton),onClick:onClick},/*#__PURE__*/react.createElement(IconArrow/* default */.A,{className:DocSidebar_styles_module.collapseSidebarButtonIcon}));}function DocSidebarDesktop(_ref3){let{path,sidebar,onCollapse,isHidden}=_ref3;const showAnnouncementBar=useShowAnnouncementBar();const{navbar:{hideOnScroll},hideableSidebar}=(0,lib/* useThemeConfig */.pN)();return/*#__PURE__*/react.createElement("div",{className:(0,clsx_m/* default */.A)(DocSidebar_styles_module.sidebar,{[DocSidebar_styles_module.sidebarWithHideableNavbar]:hideOnScroll,[DocSidebar_styles_module.sidebarHidden]:isHidden})},hideOnScroll&&/*#__PURE__*/react.createElement(Logo/* default */.A,{tabIndex:-1,className:DocSidebar_styles_module.sidebarLogo}),/*#__PURE__*/react.createElement("nav",{className:(0,clsx_m/* default */.A)('menu thin-scrollbar',DocSidebar_styles_module.menu,{[DocSidebar_styles_module.menuWithAnnouncementBar]:showAnnouncementBar})},/*#__PURE__*/react.createElement("ul",{className:(0,clsx_m/* default */.A)(lib/* ThemeClassNames */.GN.docs.docSidebarMenu,'menu__list')},/*#__PURE__*/react.createElement(DocSidebarItems,{items:sidebar,activePath:path,level:1}))),hideableSidebar&&/*#__PURE__*/react.createElement(HideableSidebarButton,{onClick:onCollapse}));}// eslint-disable-next-line react/function-component-definition
const DocSidebarMobileSecondaryMenu=_ref4=>{let{toggleSidebar,sidebar,path}=_ref4;return/*#__PURE__*/react.createElement("ul",{className:(0,clsx_m/* default */.A)(lib/* ThemeClassNames */.GN.docs.docSidebarMenu,'menu__list')},/*#__PURE__*/react.createElement(DocSidebarItems,{items:sidebar,activePath:path,onItemClick:item=>{// Mobile sidebar should only be closed if the category has a link
if(item.type==='category'&&item.href){toggleSidebar();}if(item.type==='link'){toggleSidebar();}},level:1}));};function DocSidebarMobile(props){return/*#__PURE__*/react.createElement(lib/* MobileSecondaryMenuFiller */.Gh,{component:DocSidebarMobileSecondaryMenu,props:props});}const DocSidebarDesktopMemo=/*#__PURE__*/react.memo(DocSidebarDesktop);const DocSidebarMobileMemo=/*#__PURE__*/react.memo(DocSidebarMobile);function DocSidebar(props){const windowSize=(0,useWindowSize/* default */.A)();// Desktop sidebar visible on hydration: need SSR rendering
...
/* harmony export */ });
/* harmony import */ var _home_runner_work_LAMP_platform_LAMP_platform_node_modules_babel_runtime_helpers_esm_extends_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(58168);
...
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(96540);
/* harmony import */ var _theme_Layout__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(39360);
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */function NotFound(){return/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_theme_Layout__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A,{title:(0,_docusaurus_Translate__WEBPACK_IMPORTED_MODULE_2__/* .translate */ .T)({id:'theme.NotFound.title',message:'Page Not Found'})},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("main",{className:"container margin-vert--xl"},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("div",{className:"row"},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("div",{className:"col col--6 col--offset-3"},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("h1",{className:"hero__title"},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_docusaurus_Translate__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .A,{id:"theme.NotFound.title",description:"The title of the 404 page"},"Page Not Found")),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("p",null,/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_docusaurus_Translate__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .A,{id:"theme.NotFound.p1",description:"The first paragraph of the 404 page"},"We could not find what you were looking for.")),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("p",null,/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_docusaurus_Translate__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .A,{id:"theme.NotFound.p2",description:"The 2nd paragraph of the 404 page"},"Please contact the owner of the site that linked you to the original URL and let them know their link is broken."))))));}/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (NotFound);
