...
var dist = __webpack_require__(11373);
...
var useThemeContext = __webpack_require__(49464);
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */const usePrismTheme=()=>{const{prism}=(0,lib/* useThemeConfig */.yw)();const{isDarkTheme}=(0,useThemeContext/* default */.c)();const lightModeTheme=prism.theme||palenight;const darkModeTheme=prism.darkTheme||lightModeTheme;const prismTheme=isDarkTheme?darkModeTheme:lightModeTheme;return prismTheme;};/* harmony default export */ const hooks_usePrismTheme = (usePrismTheme);
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */function CodeBlock(_ref){let{children,className:blockClassName,metastring,title}=_ref;const{prism}=(0,lib/* useThemeConfig */.yw)();const[showCopied,setShowCopied]=(0,react.useState)(false);const[mounted,setMounted]=(0,react.useState)(false);// The Prism theme on SSR is always the default theme but the site theme
...
const codeBlockTitle=(0,lib/* parseCodeBlockTitle */.QH)(metastring)||title;const prismTheme=hooks_usePrismTheme();// In case interleaved Markdown (e.g. when using CodeBlock as standalone component).
const content=Array.isArray(children)?children.join(''):children;const language=(0,lib/* parseLanguage */.K2)(blockClassName)??prism.defaultLanguage;const{highlightLines,code}=(0,lib/* parseLines */.cj)(content,metastring,language);const handleCopyCode=()=>{copyTextToClipboard(code);setShowCopied(true);setTimeout(()=>setShowCopied(false),2000);};return/*#__PURE__*/react.createElement(dist/* default */.cp,(0,esm_extends/* default */.c)({},dist/* defaultProps */.wB,{key:String(mounted),theme:prismTheme,code:code,language:language}),_ref2=>{let{className,style,tokens,getLineProps,getTokenProps}=_ref2;return/*#__PURE__*/react.createElement("div",{className:(0,clsx_m/* default */.c)(styles_module.codeBlockContainer,blockClassName,lib/* ThemeClassNames */.Wu.common.codeBlock)},codeBlockTitle&&/*#__PURE__*/react.createElement("div",{style:style,className:styles_module.codeBlockTitle},codeBlockTitle),/*#__PURE__*/react.createElement("div",{className:(0,clsx_m/* default */.c)(styles_module.codeBlockContent,language)},/*#__PURE__*/react.createElement("pre",{/* eslint-disable-next-line jsx-a11y/no-noninteractive-tabindex */tabIndex:0,className:(0,clsx_m/* default */.c)(className,styles_module.codeBlock,'thin-scrollbar'),style:style},/*#__PURE__*/react.createElement("code",{className:styles_module.codeBlockLines},tokens.map((line,i)=>{if(line.length===1&&line[0].content==='\n'){line[0].content='';}const lineProps=getLineProps({line,key:i});if(highlightLines.includes(i)){lineProps.className+=' docusaurus-highlight-code-line';}return/*#__PURE__*/react.createElement("span",(0,esm_extends/* default */.c)({key:i},lineProps),line.map((token,key)=>/*#__PURE__*/react.createElement("span",(0,esm_extends/* default */.c)({key:key},getTokenProps({token,key})))),/*#__PURE__*/react.createElement("br",null));}))),/*#__PURE__*/react.createElement("button",{type:"button","aria-label":(0,Translate/* translate */.G)({id:'theme.CodeBlock.copyButtonAriaLabel',message:'Copy code to clipboard',description:'The ARIA label for copy code blocks button'}),className:(0,clsx_m/* default */.c)(styles_module.copyButton,'clean-btn'),onClick:handleCopyCode},showCopied?/*#__PURE__*/react.createElement(Translate/* default */.c,{id:"theme.CodeBlock.copied",description:"The copied button label on code blocks"},"Copied"):/*#__PURE__*/react.createElement(Translate/* default */.c,{id:"theme.CodeBlock.copy",description:"The copy button label on code blocks"},"Copy"))));});}
...
const InfimaClasses='alert alert--info';function Details(_ref){let{...props}=_ref;return/*#__PURE__*/react.createElement(lib/* Details */.Sk,(0,esm_extends/* default */.c)({},props,{className:(0,clsx_m/* default */.c)(InfimaClasses,Details_styles_module.details,props.className)}));}
...
function unwrapMDXElement(element){if(element?.props?.mdxType&&element?.props?.originalType){const{mdxType,originalType,...newProps}=element.props;return/*#__PURE__*/react.createElement(element.props.originalType,newProps);}return element;}const MDXComponents={head:props=>{const unwrappedChildren=react.Children.map(props.children,child=>unwrapMDXElement(child));return/*#__PURE__*/react.createElement(Head/* default */.c,props,unwrappedChildren);},code:props=>{const{children}=props;// For retrocompatibility purposes (pretty rare use case)
// See https://github.com/facebook/docusaurus/pull/1584
if(/*#__PURE__*/(0,react.isValidElement)(children)){return children;}return!children.includes('\n')?/*#__PURE__*/react.createElement("code",props):/*#__PURE__*/react.createElement(CodeBlock,props);},a:props=>/*#__PURE__*/react.createElement(Link/* default */.c,props),pre:props=>{const{children}=props;// See comment for `code` above
...
const summary=items.find(item=>item?.props?.mdxType==='summary');const children=/*#__PURE__*/react.createElement(react.Fragment,null,items.filter(item=>item!==summary));return/*#__PURE__*/react.createElement(Details,(0,esm_extends/* default */.c)({},props,{summary:summary}),children);},h1:(0,Heading/* default */.c)('h1'),h2:(0,Heading/* default */.c)('h2'),h3:(0,Heading/* default */.c)('h3'),h4:(0,Heading/* default */.c)('h4'),h5:(0,Heading/* default */.c)('h5'),h6:(0,Heading/* default */.c)('h6')};/* harmony default export */ const theme_MDXComponents = (MDXComponents);
...
__webpack_require__.d(__webpack_exports__, {
  cp: () => (/* binding */ dist),
  wB: () => (/* binding */ defaultProps)
});

// UNUSED EXPORTS: Prism

// EXTERNAL MODULE: ./node_modules/prism-react-renderer/prism/index.js
var prism = __webpack_require__(96724);
