...
OAUTH_STATE="12345"
OAUTH_NONCE="67890"
`)),(0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("p",null,`Hostname needs to be the same as specified in the `,(0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("inlineCode",{parentName:"p"},`docker-compose.yaml`),` file. The `,(0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("inlineCode",{parentName:"p"},`OAUTH_LOGOUT_URL`),` is not mandatory, but it is needed so that the user is automatically logged out from Keycloak when they log out from the dashboard.`),(0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("p",null,`Remember that `,(0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("inlineCode",{parentName:"p"},`OAUTH_REDIRECT_URI`),` must be exactly the same as the redirect URI the client was set up with.`),(0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("p",null,`For further specifications on configuring Oauth for Google see the documentation here: `,(0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("a",{parentName:"p","href":"https://docs.lamp.digital/deploy/configure_oauth_google"},`https://docs.lamp.digital/deploy/configure_oauth_google`)),(0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("h2",{"id":"kubernetes-example"},`Kubernetes Example`),(0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("pre",null,(0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("code",{parentName:"pre","className":"language-yaml","metastring":"title=\"mindlamp-server.yml\"","title":"\"mindlamp-server.yml\""},`apiVersion: apps/v1
kind: Deployment
metadata:
