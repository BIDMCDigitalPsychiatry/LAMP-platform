 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */function CodeBlock(_ref){let{children,className:blockClassName,metastring,title}=_ref;const{prism}=(0,lib/* useThemeConfig */.LU)();const[showCopied,setShowCopied]=(0,react.useState)(false);const[mounted,setMounted]=(0,react.useState)(false);// The Prism theme on SSR is always the default theme but the site theme
