"use strict";
(self["webpackChunkLAMP_documentation"] = self["webpackChunkLAMP_documentation"] || []).push([[7643],{
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */function BlogListPaginator(props){const{metadata}=props;const{previousPage,nextPage}=metadata;return/*#__PURE__*/react.createElement("nav",{className:"pagination-nav","aria-label":(0,Translate/* translate */.T)({id:'theme.blog.paginator.navAriaLabel',message:'Blog list page navigation',description:'The ARIA label for the blog pagination'})},/*#__PURE__*/react.createElement("div",{className:"pagination-nav__item"},previousPage&&/*#__PURE__*/react.createElement(Link/* default */.A,{className:"pagination-nav__link",to:previousPage},/*#__PURE__*/react.createElement("div",{className:"pagination-nav__label"},"\xAB",' ',/*#__PURE__*/react.createElement(Translate/* default */.A,{id:"theme.blog.paginator.newerEntries",description:"The label used to navigate to the newer blog posts page (previous page)"},"Newer Entries")))),/*#__PURE__*/react.createElement("div",{className:"pagination-nav__item pagination-nav__item--next"},nextPage&&/*#__PURE__*/react.createElement(Link/* default */.A,{className:"pagination-nav__link",to:nextPage},/*#__PURE__*/react.createElement("div",{className:"pagination-nav__label"},/*#__PURE__*/react.createElement(Translate/* default */.A,{id:"theme.blog.paginator.olderEntries",description:"The label used to navigate to the older blog posts page (next page)"},"Older Entries"),' ',"\xBB"))));}/* harmony default export */ const theme_BlogListPaginator = (BlogListPaginator);
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */function BlogListPage(props){const{metadata,items,sidebar}=props;const{siteConfig:{title:siteTitle}}=(0,useDocusaurusContext/* default */.A)();const{blogDescription,blogTitle,permalink}=metadata;const isBlogOnlyMode=permalink==='/';const title=isBlogOnlyMode?siteTitle:blogTitle;return/*#__PURE__*/react.createElement(BlogLayout/* default */.A,{title:title,description:blogDescription,wrapperClassName:lib/* ThemeClassNames */.GN.wrapper.blogPages,pageClassName:lib/* ThemeClassNames */.GN.page.blogListPage,searchMetadata:{// assign unique search tag to exclude this page from search results!
