"use strict";
(self["webpackChunkLAMP_documentation"] = self["webpackChunkLAMP_documentation"] || []).push([[3473],{
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */const usePrismTheme=()=>{const{prism}=(0,lib/* useThemeConfig */.LU)();const{isDarkTheme}=(0,useThemeContext/* default */.Z)();const lightModeTheme=prism.theme||palenight;const darkModeTheme=prism.darkTheme||lightModeTheme;const prismTheme=isDarkTheme?darkModeTheme:lightModeTheme;return prismTheme;};/* harmony default export */ const hooks_usePrismTheme = (usePrismTheme);
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */function CodeBlock(_ref){var _parseLanguage;let{children,className:blockClassName,metastring,title}=_ref;const{prism}=(0,lib/* useThemeConfig */.LU)();const[showCopied,setShowCopied]=(0,react.useState)(false);const[mounted,setMounted]=(0,react.useState)(false);// The Prism theme on SSR is always the default theme but the site theme
...
const codeBlockTitle=(0,lib/* parseCodeBlockTitle */.bc)(metastring)||title;const prismTheme=hooks_usePrismTheme();// In case interleaved Markdown (e.g. when using CodeBlock as standalone component).
const content=Array.isArray(children)?children.join(''):children;const language=(_parseLanguage=(0,lib/* parseLanguage */.Vo)(blockClassName))!=null?_parseLanguage:prism.defaultLanguage;const{highlightLines,code}=(0,lib/* parseLines */.nZ)(content,metastring,language);const handleCopyCode=()=>{copyTextToClipboard(code);setShowCopied(true);setTimeout(()=>setShowCopied(false),2000);};return/*#__PURE__*/react.createElement(dist/* default */.ZP,(0,esm_extends/* default */.Z)({},dist/* defaultProps */.lG,{key:String(mounted),theme:prismTheme,code:code,language:language}),_ref2=>{let{className,style,tokens,getLineProps,getTokenProps}=_ref2;return/*#__PURE__*/react.createElement("div",{className:(0,clsx_m/* default */.Z)(styles_module.codeBlockContainer,blockClassName,lib/* ThemeClassNames.common.codeBlock */.kM.common.codeBlock)},codeBlockTitle&&/*#__PURE__*/react.createElement("div",{style:style,className:styles_module.codeBlockTitle},codeBlockTitle),/*#__PURE__*/react.createElement("div",{className:(0,clsx_m/* default */.Z)(styles_module.codeBlockContent,language)},/*#__PURE__*/react.createElement("pre",{/* eslint-disable-next-line jsx-a11y/no-noninteractive-tabindex */tabIndex:0,className:(0,clsx_m/* default */.Z)(className,styles_module.codeBlock,'thin-scrollbar'),style:style},/*#__PURE__*/react.createElement("code",{className:styles_module.codeBlockLines},tokens.map((line,i)=>{if(line.length===1&&line[0].content==='\n'){line[0].content='';}const lineProps=getLineProps({line,key:i});if(highlightLines.includes(i)){lineProps.className+=' docusaurus-highlight-code-line';}return/*#__PURE__*/react.createElement("span",(0,esm_extends/* default */.Z)({key:i},lineProps),line.map((token,key)=>/*#__PURE__*/react.createElement("span",(0,esm_extends/* default */.Z)({key:key},getTokenProps({token,key})))),/*#__PURE__*/react.createElement("br",null));}))),/*#__PURE__*/react.createElement("button",{type:"button","aria-label":(0,Translate/* translate */.I)({id:'theme.CodeBlock.copyButtonAriaLabel',message:'Copy code to clipboard',description:'The ARIA label for copy code blocks button'}),className:(0,clsx_m/* default */.Z)(styles_module.copyButton,'clean-btn'),onClick:handleCopyCode},showCopied?/*#__PURE__*/react.createElement(Translate/* default */.Z,{id:"theme.CodeBlock.copied",description:"The copied button label on code blocks"},"Copied"):/*#__PURE__*/react.createElement(Translate/* default */.Z,{id:"theme.CodeBlock.copy",description:"The copy button label on code blocks"},"Copy"))));});}
...
const InfimaClasses='alert alert--info';function Details(_ref){let{...props}=_ref;return/*#__PURE__*/react.createElement(lib/* Details */.PO,(0,esm_extends/* default */.Z)({},props,{className:(0,clsx_m/* default */.Z)(InfimaClasses,Details_styles_module.details,props.className)}));}
...
function unwrapMDXElement(element){var _element$props,_element$props2;if(element!=null&&(_element$props=element.props)!=null&&_element$props.mdxType&&element!=null&&(_element$props2=element.props)!=null&&_element$props2.originalType){const{mdxType,originalType,...newProps}=element.props;return/*#__PURE__*/react.createElement(element.props.originalType,newProps);}return element;}const MDXComponents={head:props=>{const unwrappedChildren=react.Children.map(props.children,child=>unwrapMDXElement(child));return/*#__PURE__*/react.createElement(Head/* default */.Z,props,unwrappedChildren);},code:props=>{const{children}=props;// For retrocompatibility purposes (pretty rare use case)
// See https://github.com/facebook/docusaurus/pull/1584
if(/*#__PURE__*/(0,react.isValidElement)(children)){return children;}return!children.includes('\n')?/*#__PURE__*/react.createElement("code",props):/*#__PURE__*/react.createElement(CodeBlock,props);},a:props=>/*#__PURE__*/react.createElement(Link/* default */.Z,props),pre:props=>{var _children$props;const{children}=props;// See comment for `code` above
if(/*#__PURE__*/(0,react.isValidElement)(children)&&/*#__PURE__*/(0,react.isValidElement)(children==null?void 0:(_children$props=children.props)==null?void 0:_children$props.children)){return children.props.children;}return/*#__PURE__*/react.createElement(CodeBlock,/*#__PURE__*/(0,react.isValidElement)(children)?children==null?void 0:children.props:{...props});},details:props=>{const items=react.Children.toArray(props.children);// Split summary item from the rest to pass it as a separate prop to the Detais theme component
const summary=items.find(item=>{var _item$props;return(item==null?void 0:(_item$props=item.props)==null?void 0:_item$props.mdxType)==='summary';});const children=/*#__PURE__*/react.createElement(react.Fragment,null,items.filter(item=>item!==summary));return/*#__PURE__*/react.createElement(Details,(0,esm_extends/* default */.Z)({},props,{summary:summary}),children);},h1:(0,Heading/* default */.Z)('h1'),h2:(0,Heading/* default */.Z)('h2'),h3:(0,Heading/* default */.Z)('h3'),h4:(0,Heading/* default */.Z)('h4'),h5:(0,Heading/* default */.Z)('h5'),h6:(0,Heading/* default */.Z)('h6')};/* harmony default export */ const theme_MDXComponents = (MDXComponents);
