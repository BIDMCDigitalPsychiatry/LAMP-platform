"use strict";
(self["webpackChunkLAMP_documentation"] = self["webpackChunkLAMP_documentation"] || []).push([[9514,4608],{
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */function DocPageContent(_ref){let{currentDocRoute,versionMetadata,children,sidebarName}=_ref;const sidebar=(0,lib/* useDocsSidebar */.Vq)();const{pluginId,version}=versionMetadata;const[hiddenSidebarContainer,setHiddenSidebarContainer]=(0,react.useState)(false);const[hiddenSidebar,setHiddenSidebar]=(0,react.useState)(false);const toggleSidebar=(0,react.useCallback)(()=>{if(hiddenSidebar){setHiddenSidebar(false);}setHiddenSidebarContainer(value=>!value);},[hiddenSidebar]);return/*#__PURE__*/react.createElement(Layout/* default */.Z,{wrapperClassName:lib/* ThemeClassNames */.kM.wrapper.docsPages,pageClassName:lib/* ThemeClassNames */.kM.page.docsDocPage,searchMetadata:{version,tag:(0,lib/* docVersionSearchTag */.os)(pluginId,version)}},/*#__PURE__*/react.createElement("div",{className:styles_module.docPage},/*#__PURE__*/react.createElement(BackToTopButton/* default */.Z,null),sidebar&&/*#__PURE__*/react.createElement("aside",{className:(0,clsx_m/* default */.Z)(styles_module.docSidebarContainer,{[styles_module.docSidebarContainerHidden]:hiddenSidebarContainer}),onTransitionEnd:e=>{if(!e.currentTarget.classList.contains(styles_module.docSidebarContainer)){return;}if(hiddenSidebarContainer){setHiddenSidebar(true);}}},/*#__PURE__*/react.createElement(DocSidebar/* default */.Z,{key:// Reset sidebar state on sidebar changes
// See https://github.com/facebook/docusaurus/issues/3414
sidebarName,sidebar:sidebar,path:currentDocRoute.path,onCollapse:toggleSidebar,isHidden:hiddenSidebar}),hiddenSidebar&&/*#__PURE__*/react.createElement("div",{className:styles_module.collapsedDocSidebar,title:(0,Translate/* translate */.I)({id:'theme.docs.sidebar.expandButtonTitle',message:'Expand sidebar',description:'The ARIA label and title attribute for expand button of doc sidebar'}),"aria-label":(0,Translate/* translate */.I)({id:'theme.docs.sidebar.expandButtonAriaLabel',message:'Expand sidebar',description:'The ARIA label and title attribute for expand button of doc sidebar'}),tabIndex:0,role:"button",onKeyDown:toggleSidebar,onClick:toggleSidebar},/*#__PURE__*/react.createElement(IconArrow/* default */.Z,{className:styles_module.expandSidebarButtonIcon}))),/*#__PURE__*/react.createElement("main",{className:(0,clsx_m/* default */.Z)(styles_module.docMainContainer,{[styles_module.docMainContainerEnhanced]:hiddenSidebarContainer||!sidebar})},/*#__PURE__*/react.createElement("div",{className:(0,clsx_m/* default */.Z)('container padding-top--md padding-bottom--lg',styles_module.docItemWrapper,{[styles_module.docItemWrapperEnhanced]:hiddenSidebarContainer})},/*#__PURE__*/react.createElement(esm/* MDXProvider */.Zo,{components:MDXComponents/* default */.Z},children)))));}function DocPage(props){const{route:{routes:docRoutes},versionMetadata,location}=props;const currentDocRoute=docRoutes.find(docRoute=>(0,react_router/* matchPath */.LX)(location.pathname,docRoute));if(!currentDocRoute){return/*#__PURE__*/react.createElement(NotFound["default"],null);}// For now, the sidebarName is added as route config: not ideal!
const sidebarName=currentDocRoute.sidebar;const sidebar=sidebarName?versionMetadata.docsSidebars[sidebarName]:null;return/*#__PURE__*/react.createElement(react.Fragment,null,/*#__PURE__*/react.createElement(Head/* default */.Z,null,/*#__PURE__*/react.createElement("html",{className:versionMetadata.className})),/*#__PURE__*/react.createElement(lib/* DocsVersionProvider */.qu,{version:versionMetadata},/*#__PURE__*/react.createElement(lib/* DocsSidebarProvider */.bT,{sidebar:sidebar},/*#__PURE__*/react.createElement(DocPageContent,{currentDocRoute:currentDocRoute,versionMetadata:versionMetadata,sidebarName:sidebarName},(0,renderRoutes/* default */.Z)(docRoutes,{versionMetadata})))));}/* harmony default export */ const theme_DocPage = (DocPage);
