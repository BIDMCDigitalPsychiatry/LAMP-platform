 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */const getVersionMainDoc=version=>version.docs.find(doc=>doc.id===version.mainDocId);function DocsVersionNavbarItem(_ref){var _ref2;let{label:staticLabel,to:staticTo,docsPluginId,...props}=_ref;const activeVersion=(0,_theme_hooks_useDocs__WEBPACK_IMPORTED_MODULE_2__/* .useActiveVersion */ .zu)(docsPluginId);const{preferredVersion}=(0,_docusaurus_theme_common__WEBPACK_IMPORTED_MODULE_3__/* .useDocsPreferredVersion */ .J)(docsPluginId);const latestVersion=(0,_theme_hooks_useDocs__WEBPACK_IMPORTED_MODULE_2__/* .useLatestVersion */ .yW)(docsPluginId);const version=(_ref2=activeVersion!=null?activeVersion:preferredVersion)!=null?_ref2:latestVersion;const label=staticLabel!=null?staticLabel:version.label;const path=staticTo!=null?staticTo:getVersionMainDoc(version).path;return/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_theme_NavbarItem_DefaultNavbarItem__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .Z,(0,_home_runner_work_LAMP_platform_LAMP_platform_node_modules_babel_runtime_helpers_esm_extends_js__WEBPACK_IMPORTED_MODULE_4__/* ["default"] */ .Z)({},props,{label:label,to:path}));}
